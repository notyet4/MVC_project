...
<html lang="ru" class="h-100">
    ...
    <div class="container">
        <h2 class="display-4"><center>СОЗДАТЬ НОВОСТЬ</center></h2>
        <br><br/>
        <form method="post" name="title_article" enctype="multipart/form-data" style="display: block; width: 400px;  padding: 20px; "  >
            ...
            <div class="form-group">
                <p>Заголовок</p> 
                <br><input id="id1" class="form-control" type="text" name="title_article" size="80" maxlength="100"><br><br>
            </div>    
            <p>Загрузить изображение*</p> 
            <br><input name="image_article" type="file" /><br><br>
            <div class="form-group">
            <p>Короткое описание</p><br> 
            <textarea name="short_article" rows="10" maxlength="1000" cols="80"></textarea><br><br>
            </div>
            <div class="form-group">
            <p>Текст статьи</p>
            <br><textarea name="article_text" rows="10" cols="80" maxlength="4500"></textarea><br>
            </div>
